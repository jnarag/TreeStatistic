 ...
 */
final public class SubtreeRootedTree implements RootedTree {
     ...
     * @param includedTaxa
     */
    public SubtreeRootedTree(RootedTree tree, Set<Taxon> includedTaxa) {
     ...
     * @return
     */
    private SubtreeRootedNode createNodes(RootedTree tree, Node node, Set<Taxon> includedTaxa) {
...
//        if( ! map.isEmpty() ) {
     ...
     * @return the created node reference
     */
    private SubtreeRootedNode createInternalNode(List<? extends Node> children) {
    ...
    public List<Node> getChildren(Node node) {
        return new ArrayList<Node>(((SubtreeRootedNode)node).getChildren());
    }
    ...
    public Node[] getNodes(Edge edge) {
        for (Node node : getNodes()) {
            if (((SubtreeRootedNode)node).getEdge() == edge) {
                return new Node[] { node, ((SubtreeRootedNode)node).getParent() };
            }
        }
        return null;
    }
    ...
    private class SubtreeRootedNode extends BaseNode {
        ...
        public SubtreeRootedNode(List<? extends Node> children) {
